...
- 设计 Timeline、GPT/Claude/Gemini Compare 与 Evidence-backed Research 三个核心体验；截至 2026-09-04 的预发布核实快照包含 49 个实体、198 条 Claim、220 条 Evidence、77 条 Relation 和 55 条 Timeline，并明确保持 `demo/cached`。
